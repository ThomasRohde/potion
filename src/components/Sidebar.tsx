...
export function Sidebar({
    ...
    return (
        <div
            data-testid="sidebar"
            className="bg-sidebar text-sidebar-foreground border-r border-sidebar-border flex flex-col h-screen"
    ...
    return (
        ...
        >
            <button
                ...
                className={`
                    peer/menu-button flex w-full items-center gap-1 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding]
            ...
            {/* Actions */}
            {(showActions || isDropdownOpen) && !isEditing && (
